...
public final class UserAlreadyExistsException extends DomainException {
  ...
  private static final String ALREADY_EXISTS_TEMPLATE = "A user with email '%s' already exists.";
  ...
  public static UserAlreadyExistsException becauseEmailAlreadyExists(final String email) {
    return new UserAlreadyExistsException(String.format(ALREADY_EXISTS_TEMPLATE, email));
  }
}
